...
namespace VSIXBundler.Core.Helpers
{
    public static class VsHelpers
    {
        ...
        public static void PromptForRestart(ISettings settings
        )
        {
            ...
            int answer = VsShellUtilities.ShowMessageBox(ServiceProvider.GlobalProvider, prompt, settings.VsixName, OLEMSGICON.OLEMSGICON_QUERY, OLEMSGBUTTON.OLEMSGBUTTON_OKCANCEL, OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND);
